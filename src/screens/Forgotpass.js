    ...
    return (
        ...
        <View style={[style.main,{backgroundColor:theme.bg}]}>
            <View style={{ paddingTop: 20 }}>
                <Text style={[style.title, { textAlign: 'center',color:theme.txt }]}>Forgot Password</Text>
                <Text style={[style.txt1, { textAlign: 'center' }]}>Enter your new password</Text>
            </View>
            <View style={{  paddingTop: 15 }}>
                <Text style={[style.txt1, { fontWeight: '500', color:theme.txt}]}>Email</Text>
                <View style={{ paddingTop: 10 }}>
                    <TextInput placeholder='Enter your email address'
                        placeholderTextColor={Colors.disable}
                        style={[style.txtinput,{fontFamily:'Itim-Regular'}]}
                    />
                </View>
                <View style={{paddingTop:20}}>
