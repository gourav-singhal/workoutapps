...
<View style={{marginTop:30,borderColor:Colors.bord,borderWidth:1,paddingHorizontal:20,paddingVertical:30,borderRadius:15}}>
            <Text style={{fontSize:12,color:Colors.disable,fontWeight:'600',fontFamily:'Itim-Regular'}}>Messages Notifications</Text>
            ...
            <View style={style.divider1}></View>
            <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                <Text style={[style.txt1,{color:theme.txt}]}>Complete Workout</Text>
                <Switch
                  trackColor={{false: Colors.disable, true: Colors.primary}}
