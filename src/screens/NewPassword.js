    ...
    return (
        ...
        <View style={[style.main,{backgroundColor:theme.bg}]}>
            <View style={{ paddingTop: 20 }}>
                <Text style={[style.title, { textAlign: 'center' ,color:theme.txt }]}>Create a </Text>
                <Text style={[style.title, { textAlign: 'center',color:theme.txt  }]}>New Password</Text>
                <Text style={[style.txt1, { textAlign: 'center' }]}>Enter your new password</Text>
            </View>
            <View style={{ paddingTop: 15 }}>
                <Text style={[style.txt1, { fontWeight: '500', color: theme.txt, }]}>Password</Text>
                ...
                <Text style={[style.txt1, { fontWeight: '500', color: theme.txt, paddingVertical: 10 }]}>Confirm Password</Text>
                <View style={[style.txtinput, {
                    flexDirection: 'row',
                    justifyContent: 'space-between',
                    alignItems: 'center',
