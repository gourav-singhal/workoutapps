        ...
        <SafeAreaView style={[style.area, { backgroundColor: theme.bg }]}>
            ...
            <View style={{ flexDirection: 'row', paddingTop: 20, }}>
                ...
                <TouchableOpacity onPress={()=>navigation.navigate('Chat')}>
                    <Text style={[style.subtitle, { color: theme.txt }]}>Edward Alesky</Text>
                ...
                <View style={{marginLeft:20}}>
                    ...
                    <View style={{
                        ...
                        <TouchableOpacity onPress={()=>navigation.navigate('Chat')}>
                        <Text style={{ textAlign: 'center', color: Colors.secondary, fontSize: 12 }}>2</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
            <View style={{ flexDirection: 'row', paddingTop: 20, }}>
                ...
                <View style={{ paddingLeft: 15 }}>
                    <TouchableOpacity onPress={()=>navigation.navigate('Chat')}>
                    <Text style={[style.subtitle, { color: theme.txt }]}>Jeden Murred</Text>
                    <Text style={[style.subtxt, { color: Colors.disable, paddingTop: 8,  }]}>Lorem ipsum dolor sit amet...</Text>
                    </TouchableOpacity>
                </View>
                <View style={{marginLeft:20}}>
            ...
            <View style={{ flexDirection: 'row', paddingTop: 20, }}>
                ...
                />
                <View style={{ paddingLeft: 15 }}>
                    <Text style={[style.subtitle, { color: theme.txt }]}>Chris Offile</Text>
                    <Text style={[style.subtxt, { color: Colors.disable, paddingTop: 8,  }]}>Lorem ipsum dolor sit amet...</Text>
                </View>
                    <Text style={[style.subtxt, { color: Colors.disable ,marginLeft:20}]}>10:20</Text>
            ...
            <View style={{ flexDirection: 'row', paddingTop: 20, }}>
                ...
                />
                <View style={{ paddingLeft: 15 }}>
                    <Text style={[style.subtitle, { color: theme.txt }]}>Jemmy Fox</Text>
                    <Text style={[style.subtxt, { color: Colors.disable, paddingTop: 8,  }]}>Lorem ipsum dolor sit amet...</Text>
                </View>
                    <Text style={[style.subtxt, { color: Colors.disable,marginLeft:20 }]}>10:20</Text>
