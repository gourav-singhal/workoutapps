...
export default function Forgot() {
    ...
    <View style={{flexDirection:'row',alignItems:'center',backgroundColor:theme.fpb,paddingVertical:20,paddingHorizontal:10,marginVertical:30}}>    
        <Avatar.Icon icon="information-variant"  
            style={{backgroundColor:'#BDBDBD',}}  
            color='white' size={25}
            />
        <View style={{marginLeft:10,marginRight:10}}>
           <Text style={{color:theme.txt,fontFamily:'Itim-Regular'}}>We will send the OTP code to your email for security in forgetting your password</Text>
        </View>
    </View>
