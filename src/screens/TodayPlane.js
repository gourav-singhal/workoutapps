...
export default function TodayPlane() {
  ...
  return (
   ...
   <Text style={{fontSize:20,color:theme.txt,fontFamily:'Itim-Regular'}}>Workout List</Text>
   ...
   <View style={{marginTop:20,flexDirection:'row',alignItems:'center',}}>
    ...
    <View style={{marginHorizontal:10}}>
        ...
        <Text style={[style.subtxt,{width:180,fontFamily:'Itim-Regular'}]}>Finish this exercise in 15 minutes</Text>    
    </View>
   ...
   <View style={{marginTop:20,flexDirection:'row',alignItems:'center',}}>
    ...
    ></Image>
    <View style={{marginHorizontal:10}}>
        <Text style={{fontSize:18,fontWeight:'600',color:theme.txt,marginBottom:5,fontFamily:'Itim-Regular'}}>Lifting Belly</Text>
   ...
   <View style={{marginTop:20,flexDirection:'row',alignItems:'center',}}>
    ...
    ></Image>
    <View style={{marginHorizontal:10}}>
        <Text style={{fontSize:18,fontWeight:'600',color:theme.txt,marginBottom:5,fontFamily:'Itim-Regular'}}>High Jump</Text>
        <Text style={[style.subtxt,{width:180}]}>Finish this exercise in 15 minutes</Text>    
    </View>
    <View style={{flex:1,alignItems:'flex-end'}}>
        <CheckBox 
   ...
   <View style={{marginTop:20,flexDirection:'row',alignItems:'center',}}>
    ...
    <View style={{flex:1,alignItems:'flex-end'}}>
     ...
     <View style={{backgroundColor:'transparent',position:'absolute',bottom:20,width:width-80,marginHorizontal:20}}>
                    <TouchableOpacity style={style.btn} onPress={()=>navigation.navigate('PlaneDetail')}>
