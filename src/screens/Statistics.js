    ...
    <SafeAreaView style={[style.area,{backgroundColor:theme.bg}]}>
        ...
        <View style={[style.main,{backgroundColor:theme.bg}]}>
         <View style={{marginTop: 50, alignItems: 'center' }}>
                <Avatar.Image source={require('../../assets/image/statisticuser4.png')}
                    size={80}
                />
                <View>
            ...
            <View style={{ paddingTop: 20, alignSelf: 'center', }}>
                <Text style={{ fontSize: 20, color: theme.txt, fontWeight: '600',fontFamily:'Itim-Regular' }}>Andeas Dewindow</Text>
            ...
            <View style={{flexDirection:'row',paddingTop:10,marginBottom:70,justifyContent:'space-between'}}>
