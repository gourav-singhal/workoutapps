...
<ScrollView showsVerticalScrollIndicator={true}>
  ...
  <Text style={{fontSize:16,fontWeight:'600',fontFamily:'Itim-Regular',color:theme.txt}}>Terms</Text>
  <View style={{marginVertical:15}}>
    <Text style={{lineHeight:20,fontFamily:'Itim-Regular',color:Colors.disable,}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eget ornare quam vel facilisis feugiat amet sagittis arcu, tortor. Sapien, consequat ultrices morbi orci semper sit nulla. Leo auctor ut etiam est, amet aliquet ut vivamus. Odio vulputate est id tincidunt fames.</Text>
    <Text style={{lineHeight:20,fontFamily:'Itim-Regular',color:Colors.disable}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eget ornare quam vel facilisis feugiat amet sagittis arcu, tortor. Sapien, consequat ultrices morbi orci semper sit nulla. Leo auctor ut etiam est, amet aliquet ut vivamus. Odio vulputate est id tincidunt fames.</Text>  
  </View>
  <Text style={{fontSize:16,fontWeight:'600',fontFamily:'Itim-Regular',color:theme.txt}}>Changes to the Service and/or Terms:</Text>
  <View style={{marginVertical:15}}>
    <Text style={{lineHeight:20,fontFamily:'Itim-Regular',color:Colors.disable}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eget ornare quam vel facilisis feugiat amet sagittis arcu, tortor. Sapien, consequat ultrices morbi orci semper sit nulla. Leo auctor ut etiam est, amet aliquet ut vivamus. Odio vulputate est id tincidunt fames.</Text>
    <Text style={{lineHeight:20,fontFamily:'Itim-Regular',color:Colors.disable}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eget ornare quam vel facilisis feugiat amet sagittis arcu, tortor. Sapien, consequat ultrices morbi orci semper sit nulla. Leo auctor ut etiam est, amet aliquet ut vivamus. Odio vulputate est id tincidunt fames.</Text> 
    <Text style={{lineHeight:20,fontFamily:'Itim-Regular',color:Colors.disable}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eget ornare quam vel facilisis feugiat amet sagittis arcu, tortor. Sapien, consequat ultrices morbi orci semper sit nulla. Leo auctor ut etiam est, amet aliquet ut vivamus. Odio vulputate est id tincidunt fames.</Text>  
